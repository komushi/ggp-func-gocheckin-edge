...
var AWS_TEMPLATE = "data.iot.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "data.iot.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "data.iot.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "data.iot.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "data.iot.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "iotdata" }, regionInfo));
};
