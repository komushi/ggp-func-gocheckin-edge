...
const IoTDataPlane_1 = require("../IoTDataPlane");
...
async function* paginateListRetainedMessages(config, input, ...additionalArguments) {
    ...
    while (hasNext) {
        ...
        if (config.client instanceof IoTDataPlane_1.IoTDataPlane) {
            page = await makePagedRequest(config.client, input, ...additionalArguments);
        }
        else if (config.client instanceof IoTDataPlaneClient_1.IoTDataPlaneClient) {
